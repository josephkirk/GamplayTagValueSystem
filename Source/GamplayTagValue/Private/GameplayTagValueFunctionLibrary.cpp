...
bool UGameplayTagValueFunctionLibrary::GetBoolTagValue(const UObject* WorldContextObject, FGameplayTag Tag, bool DefaultValue, UObject* Context)
{
    UGameplayTagValueSubsystem* Subsystem = GetGameplayTagValueSubsystem(WorldContextObject);
    if (!Subsystem)
    {
...
int32 UGameplayTagValueFunctionLibrary::GetIntTagValue(const UObject* WorldContextObject, FGameplayTag Tag, int32 DefaultValue, UObject* Context)
{
    UGameplayTagValueSubsystem* Subsystem = GetGameplayTagValueSubsystem(WorldContextObject);
    if (!Subsystem)
    {
...
float UGameplayTagValueFunctionLibrary::GetFloatTagValue(const UObject* WorldContextObject, FGameplayTag Tag, float DefaultValue, UObject* Context)
{
    UGameplayTagValueSubsystem* Subsystem = GetGameplayTagValueSubsystem(WorldContextObject);
    if (!Subsystem)
    {
...
FTransform UGameplayTagValueFunctionLibrary::GetTransformTagValue(const UObject* WorldContextObject, FGameplayTag Tag, const FTransform& DefaultValue, UObject* Context)
{
    UGameplayTagValueSubsystem* Subsystem = GetGameplayTagValueSubsystem(WorldContextObject);
    if (!Subsystem)
    {
...
TSoftClassPtr<UObject> UGameplayTagValueFunctionLibrary::GetClassTagValue(const UObject* WorldContextObject, FGameplayTag Tag, TSoftClassPtr<UObject> DefaultValue, UObject* Context)
{
    UGameplayTagValueSubsystem* Subsystem = GetGameplayTagValueSubsystem(WorldContextObject);
    if (!Subsystem)
    {
...
TSoftObjectPtr<UObject> UGameplayTagValueFunctionLibrary::GetObjectTagValue(const UObject* WorldContextObject, FGameplayTag Tag, TSoftObjectPtr<UObject> DefaultValue, UObject* Context)
{
    UGameplayTagValueSubsystem* Subsystem = GetGameplayTagValueSubsystem(WorldContextObject);
    if (!Subsystem)
    {
